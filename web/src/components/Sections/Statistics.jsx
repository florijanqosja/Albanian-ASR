              ...
              <Grid item xs={12} sm={6} md={4}>
                <Card className={classes.card}>
                  <CardContent align="center">
                    <div className={classes.circularProgressbar}>
                      <CircularProgressbar
                        value={summaryInfo.sumofLabeledDuration || 0}
                        text={`${(summaryInfo.sumofLabeledDuration || 0).toFixed(2)}%`}
                        styles={buildStyles({
                          strokeLinecap: "butt",
                          textColor: '#301616',
                          pathColor: '#301616',
                    ...
                    <Typography variant="body2">{`${(summaryInfo.total_duration_labeled || 0).toFixed(2)} / ${((summaryInfo.total_duration_labeled || 0) + (summaryInfo.total_duration_unlabeled || 0)).toFixed(2)} hours`}</Typography>
                  </CardContent>
                </Card>
              </Grid>
              <Grid item xs={12} sm={6} md={4}>
                <Card className={classes.card}>
                  <CardContent align="center">
                    <div className={classes.circularProgressbar}>
                      <CircularProgressbar
                        value={summaryInfo.sumofUnLabeledDuration || 0}
                        text={`${(summaryInfo.sumofUnLabeledDuration || 0).toFixed(2)}%`}
                        styles={buildStyles({
                          strokeLinecap: "butt",
                          textColor: '#301616',
                          pathColor: '#301616',
                    ...
                    <Typography variant="body2">{`${(summaryInfo.total_duration_unlabeled || 0).toFixed(2)} / ${((summaryInfo.total_duration_labeled || 0) + (summaryInfo.total_duration_unlabeled || 0)).toFixed(2)} hours`}</Typography>
                  </CardContent>
                </Card>
              </Grid>
              <Grid item xs={12} sm={6} md={4}>
                <Card className={classes.card}>
                  <CardContent align="center">
                    <div className={classes.circularProgressbar}>
                      <CircularProgressbar
                        value={summaryInfo.progressPercentage || 0}
                        text={`${(summaryInfo.progressPercentage || 0).toFixed(2)}%`}
                        styles={buildStyles({
                          strokeLinecap: "butt",
                          textColor: '#301616',
                          pathColor: '#301616',
                    ...
                    <Typography variant="body2">{`${(summaryInfo.total_duration_validated || 0).toFixed(2)} / ${((summaryInfo.total_duration_labeled || 0) + (summaryInfo.total_duration_unlabeled || 0)).toFixed(2)} hours`}</Typography>
                  </CardContent>
                </Card>
              </Grid>
            </Grid>
