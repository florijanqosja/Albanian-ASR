...
export default function AudioValidater() {
  ...
  const fetchAudioData = async () => {
    try {
      const response = await axios.get("https://api.uneduashqiperine.com/audio/to_validate");
      const { Sp_PATH, Sp_ID } = response.data;
      const audioURL = `https://api.uneduashqiperine.com/${Sp_PATH}`;
  ...
  const deleteAudio = async () => {
    try {
      await axios.delete("https://api.uneduashqiperine.com/audio", {
        data: {
          Sp_ID: audioID,
        },
      });
  ...
  const handleSubmit = async () => {
    try {
      await axios.put("https://api.uneduashqiperine.com/audio/validate", {
        Sp_ID: audioID,
        Sp_LABEL: labelValue,
      });
