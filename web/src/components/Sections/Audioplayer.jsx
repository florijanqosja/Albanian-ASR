...
export default function MainSection() {
  ...
  const fetchAudioData = async () => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_API_DOMAIN_LOCAL}audio/to_label`);
  ...
  const handleSubmit = async () => {
    try {
      await axios.put(`${process.env.REACT_APP_API_DOMAIN_LOCAL}audio/label`, {
        id: audioID,
        label: labelValue,
      });
